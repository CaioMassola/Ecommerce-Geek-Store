...
<header class="flex-wrap">
    ...
    <div id="rightContainer" class="d-inline-flex align-items-center justify-content-around ml-3 mr-5">
        ...
        <a href="index.php?modulo=Projeto&acao=visualizarDados"><button type="button" class="btn btn-link">
            <h4 class="px-1">Manutenção de Usuárioo</h4>
        </button>
        </a>
...
?>
    ...
    <div id="onlyProduct" class="d-inline-flex justify-content-center align-items-center flex-wrap">
        <img id="logo" class="rounded" href="" src="../../img/blusaA_1.jfif" />
        <div id="productDetails" class="d-flex flex-column p-4">
            <h1>R$ 89,90</h1>
            <h4 class="pb-4">Blusa Homem-aranha</h4>
            <h5 id="basicDetails">A blusa Homem Aranha é um produto original, licenciado e exclusivo GEEK store
            Estampa inspirada no design clássico dos quadrinhos, pra quem é fã do
            corajoso Homem Aranha. Use e colecione! Na GEEK store, prezamos por
            qualidade, diversidade e conforto. Confeccionada em 100% algodão, conta
            com estilo autêntico, feita pelos nossos nerdsigners para vestir seu lado fã!</h5>
