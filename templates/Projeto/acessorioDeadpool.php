...
<body>
    ...
    <div id="onlyProduct" class="d-inline-flex justify-content-center align-items-center flex-wrap">
        <img id="logo" class="rounded" href="" src="../../img/deadpool.jfif" />
        <div id="productDetails" class="d-flex flex-column p-4">
            <h1>R$ 14,90</h1>
            <h4 class="pb-4">Pin Deadpool</h4>
            <h5 id="basicDetails">O Pin Deadpool é um produto original e licenciado, exclusivo GEEK store.
            ...
            <h5>Material: Zamac e Metal / Medidas: aproximadamente 4cm</h5>
        </div>
        <br>
