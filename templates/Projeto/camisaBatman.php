...
?>
    ...
    <div id="onlyProduct" class="d-inline-flex justify-content-center align-items-center flex-wrap">
        <img id="logo" class="rounded" href="" src="../../img/batca.jpg" />
        <div id="productDetails" class="d-flex flex-column p-4">
            <h1>R$ 49,90</h1>
            <h4 class="pb-4">Camiseta Batman</h4>
            <h5 id="basicDetails">A camiseta Batman é um produto original, licenciado e exclusivo GEEK store.
                Pra quem é fã do super-herói mais sombrio e amado do Universo DC.
                Na GEEK store, prezamos por qualidade, diversidade e conforto. A T-Shirt
                clássica foi confeccionada em 100% algodão, conta com estilo autêntico,
                feita pelos nossos nerdsigners para vestir seu lado fã! Vista com orgulho, vista
                seu lado fã. - Modelo veste tamanho M. </h5>
