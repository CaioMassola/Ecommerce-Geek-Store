...
?>
    ...
    <div id="onlyProduct" class="d-inline-flex justify-content-center align-items-center flex-wrap">
        <img id="logo" class="rounded" href="" src="../../img/blusaB.jfif" />
        <div id="productDetails" class="d-flex flex-column p-4">
            <h1>R$ 99,90</h1>
            <h4 class="pb-4">Blusa Batman</h4>
            <h5 id="basicDetails">A blusa Batman é um produto original, licenciado e exclusivo GEEK store.
