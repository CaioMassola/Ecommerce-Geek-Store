...
<body>
    ...
    <div id="onlyProduct" class="d-inline-flex justify-content-center align-items-center flex-wrap">
        <img id="logo" class="rounded" href="" src="../../img/lord.jfif" />
        <div id="productDetails" class="d-flex flex-column p-4">
            <h1>R$ 39,90</h1>
            <h4 class="pb-4">Copo Senhor dos Anéis</h4>
            <h5 id="basicDetails">Copo Senhor dos Anéis</h5>
            <h5>Capacidade 600 ml / Largura 7cm x Comprimento 7cm</h5>
            <h5>altura de 17,8 cm produto original GEEK store. </h5>
            <h5>Materia: Plástico (AS) e acrílico</h5>
        </div>
        <br>
