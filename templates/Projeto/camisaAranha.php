...
<body>
    ...
    <div id="onlyProduct" class="d-inline-flex justify-content-center align-items-center flex-wrap">
        <img id="logo" class="rounded" href="" src="../../img/aranha.jpg" />
        <div id="productDetails" class="d-flex flex-column p-4">
            <h1>R$ 49,90</h1>
            <h4 class="pb-4">Camiseta Homem-Aranha</h4>
            <h5 id="basicDetails">A camiseta Homem-Aranha é um produto original, licenciado e exclusivo
            GEEK store. Estampa inspirada no design clássico dos quadrinhos, pra quem
            é fã do corajoso Homem Aranha. Use e colecione! Na GEEK store, prezamos
            por qualidade, diversidade e conforto. Confeccionada em 100% algodão,
