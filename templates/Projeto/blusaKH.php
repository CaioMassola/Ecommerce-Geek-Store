...
<body>
    ...
    <div id="onlyProduct" class="d-inline-flex justify-content-center align-items-center flex-wrap">
        <img id="logo" class="rounded" href="" src="../../img/kingdomhearts.jfif" />
        <div id="productDetails" class="d-flex flex-column p-4">
            <h1>R$ 99,90</h1>
            <h4 class="pb-4">Blusa Kingdom Hearts III</h4>
            <h5 id="basicDetails">A blusa Kingdom Hearts III é um produto original, licenciado e exclusivo
                GEEK store. Pra quem é fã da famosa aventura criativa da Disney e Pixar.
                Use e colecione! Na GEEK store, prezamos por qualidade, diversidade
                e conforto. Confeccionada em 100% algodão, conta com estilo autêntico,
                feita pelos nossos nerdsigners para vestir seu lado fã!
